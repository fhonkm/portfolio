...
function About() {
  ...
  return (
    <section id="aboutMe" className="my-12">
      <h2 className="mx-auto max-w-6xl px-10 text-center font-baiJum text-2xl lg:text-left">
        Who am I?
      </h2>
      <div className="mx-auto mt-12 flex max-w-6xl flex-col items-center justify-between px-6 md:mt-10 lg:flex-row">
        <AboutSkill />

        <div className="mt-10 flex w-full items-center justify-center px-4 pb-6 font-baiJum lg:w-1/2">
